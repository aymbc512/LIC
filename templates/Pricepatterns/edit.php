...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $pricepattern->price_pattern_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $pricepattern->price_pattern_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="pricepatterns form content">
            ...
            <fieldset>
                <legend><?= __('Edit Pricepattern') ?></legend>
                <?php
